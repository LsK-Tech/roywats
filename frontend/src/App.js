    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#00BFFF" },
                textPrimary: mode === "light" ? "#363636" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#363636" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "##363636" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #363636, #1C1C1C, #000000)" : "#666",
